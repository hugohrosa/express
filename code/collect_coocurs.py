...
url_verbetes = "http://services.sapo.pt/InformationRetrieval/Verbetes/GetCoOccurrences?name={0}&begin_date=2009-01-01&end_date=2015-12-31"
...
with open("DATA/coocurs_all.pkl","wb") as fid:
